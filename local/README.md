...
| Skill | Description |
| :---- | :---------- |
| [test-feature-local](./test-feature-local/) | Test features with change detection |
| [publish-to-cloud](./publish-to-cloud/) | Publish local projects to cloud |
...
cp -r publish-to-cloud ~/.cursor/skills/
