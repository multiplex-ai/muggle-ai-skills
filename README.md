...
| :--- | :--------- | :---------- | :------------ |
| **Local Testing** | `@muggle-ai/local-mcp` | `localhost`, local network | `local/` |
| **Remote Testing** | MCP Gateway (cloud) | Public URLs (staging, production) | `remote/` |
...
cp -r muggle-ai-skills/remote/* ~/.cursor/skills/
```
...
2. Add skills to appropriate folder (`local/` or `remote/`)
